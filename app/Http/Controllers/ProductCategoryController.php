...
use App\Http\Requests\StoreProductCategoryReq;
use App\Http\Requests\UpdateStoreProductCategoryReq;
...
class ProductCategoryController extends Controller
{
     ...
     */
    public function store(StoreProductCategoryReq $request)
    {
     ...
     */
    public function update(UpdateStoreProductCategoryReq $request, string $id)
    {
        $validatedRequest = $request->validated();
        try{
            $queryData = ProductCategory ::findOrFail($id);
